  ...
  return (
    <div className="bg-stone-50 min-h-screen px-6 lg:px-12 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-24 bg-stone-900 p-12 lg:p-16 text-center">
          <div className="max-w-2xl mx-auto">
            <h3 className="text-3xl lg:text-4xl font-serif italic text-white mb-6">Ready to transform your space?</h3>
            <p className="text-stone-400 mb-10 text-sm leading-relaxed uppercase tracking-widest font-bold">
